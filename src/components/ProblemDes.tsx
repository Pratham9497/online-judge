...
const ProblemDes = ({ problem, author, tab }: Props) => {
    ...
    return (
        <main className='flex md:flex-row gap-4 flex-col w-full md:h-[81vh] h-full text-white px-4'>
            {/* <ResizablePanelGroup direction="vertical" className="overflow-y-auto">
                <ResizablePanel minSize={50} className="h-full"> */}
            {/* <div className="overflow-y-auto w-full h-full px-3"> */}
            <ScrollArea className="md:w-[45%] h-full rounded-md border p-4">
            ...
            <div className='md:w-[55%] h-full flex flex-col items-left justify-center'>
