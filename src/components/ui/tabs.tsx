...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-zinc-100 p-1 dark:bg-transparent dark:border-2 text-zinc-500 dark:text-zinc-400",
      className
    )}
    {...props}
  />
